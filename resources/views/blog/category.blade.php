            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9">
                    <div class="row gap-y">
                        ...
                        <p class="text-center">
                            No results found for search : <strong style="color:mediumblue;">{{ request()->query('search') }}</strong> in Category: <strong style="color:tomato;">{{ $category->name }}</strong>
                        </p>
                        @else
                        <p class="text-center">
                            No Posts found in Category: <strong style="color:tomato;">{{ $category->name }}</strong>
                        </p>
                        @endif
                        @endforelse
