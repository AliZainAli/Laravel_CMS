...
@section('header')
<!-- Header -->
<header class="header text-white h-fullscreen pb-80" style="background-image: url('storage/posts/7.jpg');" data-overlay="9">
                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <script>
                        ...
                        (function() { // DON'T EDIT BELOW THIS LINE
                            ...
                            s.src = 'https://saas-blog-x21i6ftq6z.disqus.com/embed.js';
